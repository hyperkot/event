namespace Interfaces {
     ...
     */
    export interface Handler<T> { (eventArg: T): void; }


    /**
     * The format of the EventProperty.emit method.
     */
    export interface EmitMethod<T> { (eventArg: T): void; }

    /**
     * The format of the EventProperty:emit method for T=void.
     */
    export interface VoidEmitMethod { (): void; }
     ...
     */
    export function isListenerId(id: any) { return typeof id === "number"; }
     ...
     */
    export interface HandlerDescriptor<T> extends HandlerOptions<T> { id: ListenerId; }

    export interface Controller<T> { emit(eventArgument: T): void; }
    ...
    export interface PropertyModel<T> {
        changed: Emitter<T>;
        priorValue: T;
        value: T;
